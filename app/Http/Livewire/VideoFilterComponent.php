...
class VideoFilterComponent extends Component
{
    /**
     * Filter by month
     */
    ...
    {
        $this->availableMonths = Video::select('upload_month')
            ->distinct()
    ...
    public function getMonthName(string $month): string
    {
        ...
        return $indonesianMonths[$monthName] ?? $monthName;
    }
    ...
    {
        return view('livewire.video-filter-component');
    }
}
